...
while pkmn_selected is False:
    ...
    if pkmn_choice == 'info decidueye' or pkmn_choice == 'info hisuian decidueye':
        ...
        dramatic_effect("Sorry, but I did not understand your comand. "
                        "Answer with the name of the Pokémon or their number (eg 1, 3) on the list")
        time.sleep(1)
...
while pkmn_selected is False:
    ...
    if pkmn_choice == 'info decidueye' or pkmn_choice == 'info hisuian decidueye':
        ...
        if decidueye1 in taken:
            dramatic_effect('Sorry, that Pokémon is already taken, please use a different one')
            time.sleep(1)
            break
        taken.append(decidueye1)
        ...
        dramatic_effect('Sorry, but I did not understand your comand. Answer with the name of the Pokémon or their number (eg 1, 3) on the list')
        time.sleep(1)
